...
<div id="page-content" class="flex-grow-1">
  ...
  <?php
  $filename = "Validation.csv"; // Chemin vers le fichier CSV
  ...
  ?>
  <form id="blogForm" enctype="multipart/form-data" action="index3.php" method="POST" onsubmit="refreshPage()">
<button id="edit-button" class="btn btn-primary profile-button" onclick="enableEditMode()" form="form1" formaction="enregistrer.php">Modifier</button>
 ...
 <button id="delete-button" class="btn btn-danger profile-button" onclick="deleteProduct()">Validation</button>
</form>
</div>
<div id="footer">
  <div class="container">
